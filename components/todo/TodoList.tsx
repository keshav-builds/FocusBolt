...
export function TodoList({ open, onOpenChange, currentTheme }: TodoListProps) {
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      default: return currentTheme.separatorColor;
    }
  };
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 text-sm rounded-xl border hover:opacity-90 transition-opacity disabled:opacity-50"
                        style={{
                      ...
                      {!showAddCategory ? (
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="px-2 py-1 text-xs rounded-lg border w-32"
                            style={{
                              backgroundColor: isImageTheme ? 'rgba(255, 255, 255, 0.1)' : currentTheme.background,
                              color: isImageTheme ? 'rgba(255, 255, 255, 0.9)' : currentTheme.digitColor,
                              borderColor: isImageTheme ? 'rgba(255, 255, 255, 0.3)' : currentTheme.cardBorder,
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor: filter === filterType 
                            ? (isImageTheme ? 'rgba(255, 255, 255, 0.2)' : currentTheme.digitColor + '20')
                            : (isImageTheme ? 'rgba(255, 255, 255, 0.1)' : 'transparent'),
                          color: isImageTheme ? 'rgba(255, 255, 255, 0.9)' : currentTheme.digitColor,
                          borderColor: isImageTheme ? 'rgba(255, 255, 255, 0.3)' : currentTheme.cardBorder,
                        }}
                      >
  ...
  style={{
    backgroundColor: isImageTheme ? 'rgba(255, 255, 255, 0.08)' : `${currentTheme.background}20`,
    border: `1px solid ${isImageTheme ? 'rgba(255, 255, 255, 0.2)' : currentTheme.cardBorder}`,
    borderLeftWidth: '3px',
...
>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                <span 
                                  className="text-xs"
                                  style={{ color: isImageTheme ? 'rgba(255, 255, 255, 0.6)' : currentTheme.separatorColor }}
                                >
                                  {todo.priority}
                                </span>
                              </div>
                          ...
                          <button
                            ...
                            className="p-1 rounded-lg hover:scale-110 transition-transform text-red-500  hover:bg-opacity-20"
                            style={{
