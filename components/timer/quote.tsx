  ...
  return (
    ...
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 105 78"
        className="absolute left-2 top-4  w-14 h-10 opacity-30 z-0"
        style={{
      ...
      >
        <p className="text-lg font-medium italic">&ldquo;{quote.text}&rdquo;</p>
        <p className="mt-0 text-lg opacity-80 ">— {quote.author}</p>
      </div>
    </div>
  );
}
